...
const today = format(startOfToday(), 'yyyy-MM-dd HH:mm:ss.SSS');
const tomorrow = format(startOfTomorrow(), 'yyyy-MM-dd HH:mm:ss.SSS');
...
export class Bootstrap1568307883445 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      INSERT INTO "user" (created_at, id, first_name, last_name, date_of_birth) VALUES('2019-09-20 22:42:04.837', '3f045e1b-3ff7-429c-9ca1-e4e7585b48a6', 'User 8', 'Square 64', '${today}');
      INSERT INTO "user" (created_at, id, first_name, last_name, date_of_birth) VALUES('2019-09-20 22:42:04.837', 'b9ca41e9-9ce9-4852-8b11-c6386cfb0e25', 'User 9', 'Square 81', '${tomorrow}');
      `
    );
  }
