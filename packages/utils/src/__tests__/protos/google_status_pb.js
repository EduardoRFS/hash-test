...
var google_any_pb = require('./google_any_pb.js');
goog.object.extend(proto, google_any_pb);
...
proto.google.rpc.Status.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    google_any_pb.Any.toObject, includeInstance)
  };
...
proto.google.rpc.Status.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new google_any_pb.Any;
      reader.readMessage(value,google_any_pb.Any.deserializeBinaryFromReader);
...
proto.google.rpc.Status.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      google_any_pb.Any.serializeBinaryToWriter
    );
  }
};
...
proto.google.rpc.Status.prototype.getDetailsList = function() {
  return /** @type{!Array<!proto.google.protobuf.Any>} */ (
    jspb.Message.getRepeatedWrapperField(this, google_any_pb.Any, 3));
};
